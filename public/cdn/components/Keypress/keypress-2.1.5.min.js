...
(function () {
	...
	var g = function (a, c) {
		...
		"undefined" !== typeof jQuery &&
			...
			a instanceof jQuery &&
			(1 !== a.length &&
				p("Warning: your jQuery selector should have exactly one object."),
			(a = a[0]));
	...
	g.prototype._get_potential_combos = function (a) {
		...
		for (e = f.length; d < e; d++)
			(c = f[d]),
				c.is_sequence ||
					(0 <= j.call(c.keys, a) && this._cmd_bug_check(c.keys) && b.push(c));
		return b;
	};
	...
	g.prototype._handle_combo_down = function (a, c, b, d) {
		...
		e = !1;
		if (0 <= j.call(this._keys_down, b) && ((e = !0), !a.allows_key_repeat()))
			return !1;
		...
		if (
			!b &&
			(a.is_counting && "function" === typeof a.on_keydown && (a.count += 1), h)
		)
	...
	g.prototype._handle_combo_up = function (a, c, b) {
		...
		if (
			!a.keyup_fired &&
			((d = this._keys_down.slice()), d.push(b), !a.is_solitary || u(d, a.keys))
		)
	...
	g.prototype.unregister_combo = function (a) {
		...
		for (e = f.length; d < e; d++)
			(c = f[d]),
				null != c &&
					((c.is_unordered && u(a, c.keys)) || (!c.is_unordered && x(a, c.keys))
						? g.push(b(c))
						: g.push(void 0));
		return g;
	};
